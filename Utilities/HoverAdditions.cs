...
namespace XRayVision.Utilities
{
    ...
    {
        public static void AddHoverText(GameObject obj, ref string __result)
        {
            /* Colored text examples https://docs.unity3d.com/Packages/com.unity.ugui@1.0/manual/StyledText.html */
            if (!XRayVisionPlugin.isAdmin) return;
        ...
        public static void AddPlayerHoverText(GameObject obj, ref string __result)
        {
            /* Colored text examples https://docs.unity3d.com/Packages/com.unity.ugui@1.0/manual/StyledText.html */
            if (!XRayVisionPlugin.isAdmin) return;
            StringBuilder stringBuilder = new();
